...
class Footer {
   ...
   *
   * TODO: piwikTracker.setDownloadClasses( "download" ); should be set to the
   *   default download class of TYPO3
   * TODO: Track TYPO3 404 Errors ... http://piwik.org/faq/how-to/#faq_60
   *
  ...
  public function contentPostProc_output($trackingCode, $localConfig) {
    ...
    //check wether there is a BE User loggged in, if yes avoid to display the
    //tracking code!
    ...
    //currently the function $this->getPiwikHost() is not called, because of
    //piwikintegration?!
  ...
  /**
   * Generates javascript code for using custom variables and initializes custom
   * variables in the piwikTracker API for image tracking.
   *
